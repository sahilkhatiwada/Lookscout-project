  ...
  return (
    <section className="bg-white ">
      <div className="py-8 px-5 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="max-w-screen-lg md:mx-auto text-center mb-8 lg:mb-16 ">
          <h2 className="mb-3 text-3xl tracking-tight font-extrabold text-gray-900 flex flex-col ">
            Messaging for all
          </h2>
          <p className="text-gray-500 sm:text-xl text-center">
            User generated content in real-time will have multiple touch points
            for users to engage with your content.
          </p>
        </div>
